                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: readOnly ? 0 : '10px' }}>
                      ...
                      {!readOnly && (
                        <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                          <button
                            onPointerUp={e => { e.stopPropagation(); setEditExerciseModal({ id: ex.exerciseId, name: ex.name }); setEditExerciseName(ex.name) }}
                            style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '3px', padding: '6px 10px', color: 'rgba(255,255,255,0.4)', fontSize: '16px', touchAction: 'manipulation' }}>✏️</button>
                          ...
                          <button
                            onPointerUp={e => { e.stopPropagation(); removeExercise(day, ex.idx) }}
                            style={{ background: 'none', border: 'none', color: 'rgba(232,92,26,0.5)', fontSize: '20px', padding: '4px 8px', touchAction: 'manipulation' }}>✕</button>
                        </div>
                      )}
                    </div>
