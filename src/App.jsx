    ...
    <>
      ...
      {needRefresh && (
        <div style={{
          ...
          background: '#1a1a1a', border: '1px solid var(--acc-bordo-marcato)',
          ...
          <div style={{ background: '#1a1a1a', border: '1px solid var(--bordo)', borderRadius: '12px', padding: '28px 24px', width: '100%', maxWidth: '320px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button onClick={() => setShowExitModal(false)}
                style={{ flex: 1, background: 'var(--sup-alta)', border: '1px solid var(--bordo)', borderRadius: '6px', padding: '13px', color: '#fff', fontFamily: 'Barlow Condensed, sans-serif', fontSize: '14px', fontWeight: '700', letterSpacing: '1px', cursor: 'pointer' }}>
                {puoUscire() ? 'RESTA' : 'OK'}
              </button>
              ...
              {puoUscire() && (
                <button onClick={() => { setShowExitModal(false); window.history.go(-2) }}
                  style={{ flex: 1, background: 'var(--acc-riempimento)', border: '1px solid var(--acc-bordo-forte)', borderRadius: '6px', padding: '13px', color: 'var(--accento)', fontFamily: 'Barlow Condensed, sans-serif', fontSize: '14px', fontWeight: '700', letterSpacing: '1px', cursor: 'pointer' }}>
                  ESCI
                </button>
              )}
            </div>
